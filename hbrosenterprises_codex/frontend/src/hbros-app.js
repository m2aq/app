...
function addGpsPointToDraft() {
    ...
    navigator.geolocation.getCurrentPosition(
        pos => {
            addDraftPoint(pos.coords.latitude, pos.coords.longitude);
        },
        () => alert('Could not read GPS position.'),
...
function toggleGpsTrack() {
    ...
    fieldDraft.gpsWatchId = navigator.geolocation.watchPosition(
        pos => addDraftPoint(pos.coords.latitude, pos.coords.longitude),
